...
const delays = [0.05, 0.22, 0.38, 0.52, 0.66, 0.8];

const revealStyle = (i: number): React.CSSProperties => ({
  opacity: 0,
  animation: `heroFadeUp 1.0s cubic-bezier(0.22, 1, 0.36, 1) ${delays[i]}s forwards`,
});
...
const dotStyle: React.CSSProperties = {
  transform: "scale(0)",
  opacity: 0,
  animation: `heroDotPop 0.4s cubic-bezier(0.34, 1.56, 0.64, 1) 0.50s forwards`,
};
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto px-8 lg:px-16 py-28 flex flex-col items-center text-center gap-8">
          ...
          <div className="flex items-center gap-3">
            <div style={lineStyle(0.38)} className="h-px w-10 bg-primary/30" />
            <Scale size={14} style={dotStyle} className="text-primary/50" />
            <div style={lineStyle(0.38)} className="h-px w-10 bg-primary/30" />
          </div>
          ...
          <div style={revealStyle(4)} className="flex items-center gap-4 mt-4">
